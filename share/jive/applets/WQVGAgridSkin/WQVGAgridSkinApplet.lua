...
applets.WQVGAgridSkin.WQVGAgridSkinApplet

=head1 DESCRIPTION

This applet implements a grid view skin for 480x272 resolution
...
local log                    = require("jive.utils.log").logger("applet.WQVGAgridSkin")
