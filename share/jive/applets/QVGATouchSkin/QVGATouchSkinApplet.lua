...
applets.QVGATouchSkin.QVGATouchSkinApplet
...
local log                    = require("jive.utils.log").logger("applet.QVGATouchSkin")
...
local imgpath = "applets/QVGATouchSkin/images/"
...
function param(self)
		...
		radialClock = {
			hourTickPath     = 'applets/QVGATouchSkin/images/Clocks/Radial/radial_ticks_hr_on.png',
			minuteTickPath   = 'applets/QVGATouchSkin/images/Clocks/Radial/radial_ticks_min_on.png',
		},
...
function skin(self, s)
	Framework:setVideoMode(320, 240, 0, false)
...
--------- ICONBAR ---------
	...
	s.nowplaying = _uses(s.window, {
		...
		'div5','butspacer','div6', 'volDown', 'div7', 'volUp' },
			position = LAYOUT_SOUTH,
			h = controlHeight,
			w = WH_FILL,
			...
			butspacer = _uses(_transportControlButton, {
				w = 15, 
				img = _loadImage(self, "Icons/icon_toolbar_blank.png"),
			}),
	...
	s.nowplaying.npcontrols.pressed = {
		...
		butspacer = _uses(s.nowplaying.npcontrols.butspacer, { bgImg = keyMiddlePressed }),
